'''
Extract Features:
HOG, Spatial Bins, Histogram of Colors
'''
import numpy as np
import cv2
...
class FeatureExtractor():
    ...
    def extract_features(self, image_list, cspace, spatial_size, hist_bins, hist_range,
                         hog_orient, hog_pix_per_cell, hog_cell_per_block, hog_channel,reduce_size=False):
